    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer){
        ...
        try {
            if (className!=null&&className.equalsIgnoreCase("java/rmi/server/RemoteObjectInvocationHandler")){
                ...
                Constructor<?> ctor = Class.forName("com.firebasky.javassist.RemoteObjectInvocationHandlerHookVisitor").getDeclaredConstructor(new Class[]{ClassVisitor.class, String.class});
